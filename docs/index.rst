...
**Oct, 2016 -- svviz 1.5.3** svviz 1.5.3 has been released. Upgrade using the following pip command: ``sudo pip install --upgrade svviz``. You can see a list of the changes :ref:`here <changelog>`.
